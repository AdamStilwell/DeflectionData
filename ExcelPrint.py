...
def print_summary_worksheet(worksheet, my_deflection, number_of_sheets):
    ...
    worksheet.write(number_of_sheets, 10, my_deflection.fifty_psi)
    worksheet.write(number_of_sheets, 11, my_deflection.minimum_gap)
    worksheet.write(number_of_sheets, 12, my_deflection.strain_to_break)

    # power law headings
    # "Amplitude"
    worksheet.write(number_of_sheets, 13, my_deflection.power_law_values[0][0])
    # "Power Law Index"
    worksheet.write(number_of_sheets, 14, my_deflection.power_law_values[0][1])
    # "Offset"
    worksheet.write(number_of_sheets, 15, my_deflection.power_law_values[0][2])
